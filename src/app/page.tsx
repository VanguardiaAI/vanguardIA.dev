...
const OptimizedServicesSection = memo(ServicesSection);
const OptimizedCTASection = memo(CTASection);
              ...
              <div className="md:col-span-2">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="relative w-8 h-8">
                    <Image
                      ...
                      priority // Priorizar carga de logo
                      loading="eager"
                    />
                  </div>
                ...
                <div className="flex space-x-4">
                  <motion.a 
                    ...
                    className="w-10 h-10 bg-neutral-800 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-all duration-300 group"
