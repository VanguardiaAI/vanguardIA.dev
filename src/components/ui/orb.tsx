...
// Shaders definidos fuera del componente para evitar recreación
const vert = /* glsl */ `
...
export default function Orb({
  ...
  // Siempre ejecutar useEffect principal
  useEffect(() => {
    if (isLowEnd) return; // No hacer nada si es dispositivo lento
