      ...
      <div className="w-full h-screen bg-black relative overflow-hidden flex flex-col md:flex-row pt-20">
        ...
        <div className="w-full md:w-2/5 flex flex-col justify-between px-6 md:px-8 lg:px-12 xl:px-16 py-8 md:py-12">
          ...
          <div className="max-w-lg pt-4 md:pt-8">
            <p className="text-gray-400 text-base md:text-lg leading-relaxed mb-6 md:mb-8 font-lora italic">
            ...
            <p className="text-gray-400 text-base md:text-lg leading-relaxed mb-8 md:mb-12 font-lora italic">
              En VanguardIA, no vendemos tecnología del futuro. Construimos el presente de los negocios inteligentes.&rdquo;
            </p>
            
            {/* CEO Info */}
            <div>
              <p className="text-white font-medium text-xl md:text-2xl font-lora italic">Pablo Luque</p>
              <p className="text-gray-500 text-base md:text-lg italic font-lora">Founder & AI Architect</p>
            </div>
          </div>
